...
def ricci_sender_1(df,type):
    ...
    df_students = pd.read_csv('https://docs.google.com/spreadsheets/d/e/2PACX-1vTZGOfhMdZXzXj_tLDptmmM2HKLmcF_0uLq9w1EQ8T4PRSBW6PuYafIptqFEKn60ONWw_4rrD4lQvYh/pub?gid=0&single=true&output=csv')
