import pandas as pd
from email_functions import ricci_group_1_emails, telegram_sender, ricci_group_2_emails, principia_1_emails, principia_2_emails, telegram_sender_principia
...
def df_trend_calc_shorts(list, list2, list3):
    ...
    if (list != []):
        ...
        #ricci_group_1_emails.ricci_sender_1(df,'Trend Trades 1 hr short')
        #ricci_group_2_emails.ricci_sender_2(df,'Trend Trades 1 hr short')
        principia_1_emails.principia_sender_1(df,'Trend Trades 1 hr short')
        principia_2_emails.principia_sender_2(df, 'Trend Trades 1 hr short')
        telegram_sender.send_telegram_message(df,'Trend Trades 1 hr short')
        telegram_sender_principia.send_telegram_message(df, 'Trend Trades 1 hr short')
