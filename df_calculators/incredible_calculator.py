...
def df_incredible_calc(list, list2, list3):
    ...
    if (list != []):
        ...
        #ricci_group_1_emails.ricci_sender_1(df,'Incredible Trades 1 hr long')
        #ricci_group_2_emails.ricci_sender_2(df, 'Incredible Trades 1 hr long')
        #principia_1_emails.principia_sender_1(df, 'Incredible Trades 1 hr long')
        #principia_2_emails.principia_sender_2(df, 'Incredible Trades 1 hr long')
        telegram_sender.send_telegram_message(df,'Incredible Trades 1 hr long')
        telegram_sender_principia.send_telegram_message(df, 'Incredible Trades 1 hr long')
        telegram_sender_quant.send_telegram_message(df, 'Incredible Trades 1 hr long')
        telegram_sender_bono6m.send_telegram_message(df, 'Incredible Trades 1 hr long')
